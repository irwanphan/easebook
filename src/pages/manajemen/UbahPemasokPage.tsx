  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      <div>
        ...
        <PageHeader title="Ubah pemasok" description="Perbarui data kontak; kode tidak dapat diubah." />
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {loading || !ready ? (
            ...
            <KontakMasterFields idPrefix="sup-edit" values={values} onChange={setValues} kodeReadOnly />
          )}
