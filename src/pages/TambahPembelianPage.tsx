...
import { METODE_PEMBAYARAN_PEMBELIAN, type MetodePembayaranPembelian } from "@/data/pembelian";
...
export function TambahPembelianPage() {
  ...
  const [metodePembayaran, setMetodePembayaran] = useState<MetodePembayaranPembelian>("TUNAI");
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      await invoke<string>("pembelian_insert", {
        payload: {
    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      <div>
        ...
        <PageHeader
          ...
          description="Catat pembelian dari pemasok: pilih gudang, tanggal, item, dan pembayaran lalu simpan ke database lokal."
        />
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <Card>
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            <div className="sm:col-span-2">
              <label htmlFor="fb-pemasok" className="block text-sm font-medium text-zinc-700">
                Pemasok
              </label>
              <select
                id="fb-pemasok"
            ...
            <div>
              <label htmlFor="fb-gudang" className="block text-sm font-medium text-zinc-700">
                Gudang tujuan
              </label>
              <select
                id="fb-gudang"
            ...
            <div>
              <label htmlFor="fb-metode" className="block text-sm font-medium text-zinc-700">
                Pembayaran
              </label>
              <select
                id="fb-metode"
                value={metodePembayaran}
                onChange={(e) => setMetodePembayaran(e.target.value as MetodePembayaranPembelian)}
                className={inputClass}
              >
            ...
            <div>
              <label htmlFor="fb-tgl" className="block text-sm font-medium text-zinc-700">
                Tanggal faktur
              </label>
              <input
                id="fb-tgl"
            ...
            <div>
              <label htmlFor="fb-jt" className="block text-sm font-medium text-zinc-700">
                Jatuh tempo
              </label>
              <input
                id="fb-jt"
        ...
        <Card className="overflow-hidden">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Button type="button" variant="secondary" className="shrink-0 gap-2" onClick={addLine}>
        ...
        <div className="flex flex-wrap justify-end gap-3">
          <Button type="button" variant="ghost" onClick={() => navigate("/pembelian")}>
            Batal
          </Button>
