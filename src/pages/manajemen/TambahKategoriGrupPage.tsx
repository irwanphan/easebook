...
export function TambahKategoriGrupPage() {
  const navigate = useNavigate();
  const { addItem, kodeExists } = useKategoriGrup();
      ...
      <Card>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-end gap-3 border-t border-zinc-100 pt-5">
            <Button type="button" variant="ghost" onClick={() => navigate("/manajemen/kategori")}>
              Batal
            </Button>
