...
export const halamanAksesGroups: HalamanAksesGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "ke-piutang", label: "Pelunasan piutang", pathPattern: "keuangan/pelunasan-piutang" },
      { key: "ke-piutang-daftar", label: "Daftar pelunasan piutang", pathPattern: "keuangan/pelunasan-piutang/daftar" },
      {
        key: "ke-piutang-daftar-detail",
        label: "Detail pelunasan piutang",
        pathPattern: "keuangan/pelunasan-piutang/daftar/:nomor",
      },
      { key: "ke-piutang-buat", label: "Buat pelunasan piutang", pathPattern: "keuangan/pelunasan-piutang/buat" },
      { key: "ke-hutang", label: "Pelunasan hutang", pathPattern: "keuangan/pelunasan-hutang" },
      { key: "ke-hutang-daftar", label: "Daftar pelunasan hutang", pathPattern: "keuangan/pelunasan-hutang/daftar" },
      {
        key: "ke-hutang-daftar-detail",
        label: "Detail pelunasan hutang",
        pathPattern: "keuangan/pelunasan-hutang/daftar/:nomor",
      },
      { key: "ke-hutang-buat", label: "Buat pelunasan hutang", pathPattern: "keuangan/pelunasan-hutang/buat" },
