...
export function DaftarPelunasanPiutangPage() {
  ...
  const fetchRows = useCallback(async () => {
    ...
    setError(null);
    try {
      const list = await invoke<PelunasanPiutangRiwayatRow[]>("pelunasan_piutang_riwayat_list", {
    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-6">
      <div>
        ...
        <PageHeader
          ...
          description="Riwayat pelunasan piutang yang tercatat di sistem. Klik baris untuk melihat detail faktur dan kas penerimaan."
        />
      </div>
          ...
          <table className="w-full min-w-[960px] text-left text-sm">
            <thead>
              <tr className="border-b border-zinc-100 bg-zinc-50/90 text-xs font-semibold uppercase tracking-wide text-zinc-500">
                ...
                <th className="px-5 py-3">Diterima ke kas</th>
